...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do RC Desk..."),
        ...
        ("install_tip", "Devido ao UAC, o RC Desk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o RC Desk no sistema."),
        ("Click to upgrade", "Iniciar atualização"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao RC Desk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao RC Desk permissões de \"Gravar a Tela\""),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o RC Desk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [RC Desk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep RC Desk background service", "Manter o serviço do RC Desk executando em segundo plano"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do RC Desk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do RC Desk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do RC Desk."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do RC Desk"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o RC Desk e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o RC Desk Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o RC Desk funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por RC Desk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões somente com o RC Desk aberto"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço RC Desk em segundo plano"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente RC Desk para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o RC Desk verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o RC Desk ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o RC Desk não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor RC Desk OSS não inclui este recurso."),
        ...
        ("RC Desk cannot reach the desktop session on the remote device, check that a desktop session is running and that RC Desk can use it", "O RC Desk não consegue acessar a sessão da área de trabalho no dispositivo remoto, verifique se há uma sessão da área de trabalho em execução e se o RC Desk pode acessá-la."),
        ...
        ("RC Desk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "O RC Desk não conseguiu obter uma tela utilizável do XDG Desktop Portal. A biblioteca do PipeWire pode estar desatualizada."),
        ("RC Desk could not load a GStreamer component needed for screen capture ({})", "O RC Desk não conseguiu carregar um componente do GStreamer necessário para a captura de tela ({})."),
